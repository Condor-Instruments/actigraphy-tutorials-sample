...
activity_threshold_quantile = 0.3
...
def offwrist_wrapper_actlumus(df,verbose=False,file_verbose=False,filename=""):
    ...
    if len(data) > 0:
        ...
        refiner = BimodalOffwristRefiner(activity_threshold_quantile=activity_threshold_quantile,
                                            ...
                                            lumus_short_offwrist_maximum_capsensor_pvalue = lumus_short_offwrist_maximum_capsensor_pvalue,
